...
public abstract class MicroService implements Runnable {
    ...
    private Map<Class<? extends Broadcast>, Callback> bcastCallbacks = new ConcurrentHashMap<>();
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        ...
        bcastCallbacks.put(type, callback);
    }
       ...
       if(getName() == "Time Service"){
           ...
           while (isRunning) {
               ...
               if (message instanceof Event)
                   ...
                   bcastCallbacks.get(message.getClass()).call(message);
           }
       }
       mb.unregister(this);
    }
